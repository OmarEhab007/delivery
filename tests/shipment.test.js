...
describe('Shipment Management Module Tests', () => {
  ...
  describe('Shipment Creation', () => {
    it('should create a new shipment for a merchant', async () => {
      ...
      expect(response.body.data.shipment.origin).toHaveProperty(
        'address',
        shipmentData.origin.address
      );
      expect(response.body.data.shipment.destination).toHaveProperty(
        'address',
  ...
  describe('Shipment Management', () => {
    ...
    it.skip('should update a shipment', async () => {
      ...
      expect(response.status).toBe(200);
      expect(response.body.data.shipment.cargoDetails).toHaveProperty(
        'description',
  ...
  describe('Shipment Status Management', () => {
    it.skip('should update shipment status', async () => {
      ...
      expect(
        response.body.data.shipment.timeline[response.body.data.shipment.timeline.length - 1]
